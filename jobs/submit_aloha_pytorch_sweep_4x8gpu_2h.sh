...
# 8h run reached about step 6300 before timeout, so 1500 steps is a
# realistic 2h-ish target while still giving us evals at 500 and 1000.
COMMON_ARGS="--num-train-steps=1500 --save-interval=500 --log-interval=20 --periodic-eval-num-examples=4 --final-eval-num-examples=0 --wandb-checkpoint-artifact-interval=500 --model.pytorch-compile-mode=None"
...
submit_job "aloha-pytorch-b32-lr1e5-2h" 32 1e-5
submit_job "aloha-pytorch-b32-lr1p25e5-2h" 32 1.25e-5
submit_job "aloha-pytorch-b32-lr1p5e5-2h" 32 1.5e-5
submit_job "aloha-pytorch-b32-lr1p75e5-2h" 32 1.75e-5
